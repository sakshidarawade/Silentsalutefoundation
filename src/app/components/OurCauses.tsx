    ...
    <section className="relative overflow-hidden bg-[#f4efe8] py-20"> 
      ...
      <div className="relative z-10 mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8"> 
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2"> 
          ...
          {/* EDUCATION */} 
          <div className="group relative overflow-hidden rounded-[24px] border border-[#d6a64c]/80 bg-[#0d4236] shadow-[0_20px_40px_rgba(13,27,42,0.12)] transition-all duration-300 hover:-translate-y-1 hover:border-[#d6a64c] hover:shadow-[0_24px_52px_rgba(13,27,42,0.18)] active:-translate-y-1 active:border-[#d6a64c] active:shadow-[0_24px_52px_rgba(13,27,42,0.18)]">
            ...
            <div className="relative z-10 flex min-h-[420px] flex-col justify-between p-6 md:p-8"> 
              ...
              <div className="flex items-center justify-start"> 
                ...
                <div className="flex h-16 w-16 items-center justify-center rounded-full border-[2px] border-[#d6a64c] bg-[#0a2530]/20 backdrop-blur-sm transition-all duration-300 group-hover:shadow-[0_0_20px_rgba(214,166,76,0.35)] group-active:shadow-[0_0_20px_rgba(214,166,76,0.35)]">
