        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div className="group relative z-10 flex min-h-[310px] flex-col items-center rounded-2xl border border-border bg-white p-8 text-center transition-all duration-300 hover:border-accent hover:shadow-xl active:border-accent active:shadow-xl">
                ...
                <div className="icon-circle mb-5 transition-all group-hover:border-accent group-hover:bg-accent group-active:border-accent group-active:bg-accent">

                  <Icon
                    name={step.icon as 'MagnifyingGlassIcon'}
                    size={28}
                    className="text-accent group-hover:text-white group-active:text-white"
                  />
