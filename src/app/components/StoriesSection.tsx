...
export default function StoriesSection() {
  ...
  const isImpactPage = useLocation().pathname === '/impact';
  ...
  const nextStorySlide = () => {
    setStorySlideIndex((currentIndex) => Math.min(currentIndex + 1, 1));
  };

  const previousStorySlide = () => {
    setStorySlideIndex((currentIndex) => Math.max(currentIndex - 1, 0));
  };
  ...
  return (
    <>
      ...
      <section
        className={`relative overflow-hidden bg-[#061f35] text-white ${
          isImpactPage
            ? 'min-h-[calc(100vh+120px)] py-20 lg:py-28'
            : 'py-16 sm:py-24 lg:py-28'
        }`}
      >
        <div className="mx-auto max-w-[1500px] px-4 sm:px-6 lg:px-8">
          <div className="stories-section-layout grid items-center gap-6 xl:grid-cols-[0.92fr_2.15fr]">
            ...
            <div className="flex justify-end xl:translate-x-[20px]">
              <div className="stories-carousel relative w-full max-w-[930px] xl:overflow-hidden">
                <div
                  className="stories-carousel-track grid gap-4 md:grid-cols-2 xl:flex xl:transition-transform xl:duration-500 xl:ease-out 2xl:grid"
                  style={{
                    transform: `translateX(-${storySlideIndex * 25}%)`,
                  }}
                >
                ...
                {visibleStories.map((story) => (
                  <RouterLink
                    ...
                    className="
                      ...
                      active:border-[#f3b659]/70
                      active:shadow-[0_18px_34px_rgba(0,0,0,0.28)]
                      xl:w-[calc((100%_-_2rem)/3)]
                      xl:flex-shrink-0
                      2xl:w-auto
                    "
                  >
                ...
                <button
                  type="button"
                  onClick={previousStorySlide}
                  aria-label="Show previous stories"
                  disabled={storySlideIndex === 0}
                  className="stories-carousel-arrow
                    absolute
                    left-2
                    top-1/2
                    z-20
