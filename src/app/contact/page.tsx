...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await submitForm({ type: 'contact', ...formData });
      setSubmitted(true);
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#d6a64c] py-4 text-sm font-bold tracking-[0.08em] text-[#041e2e] transition-all duration-300 hover:bg-[#c6943b] disabled:cursor-not-allowed disabled:opacity-60"
                  >
